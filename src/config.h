...
static const char slopspawnstyle[]  = "-t 0 -l -c 0.92,0.85,0.69,0.3"; /* do NOT define -f (format) or -b (borderwidth) here */
static const char slopresizestyle[] = "-t 0 -l -c 0.92,0.85,0.69,0.3"; /* do NOT define -f (format) or -b (borderwidth) here */
